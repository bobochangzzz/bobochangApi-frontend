...
/** 创建接口信息接口 POST /api/interfaceInfo/add */
...
/** 删除接口信息接口 POST /api/interfaceInfo/delete */
...
/** 根据id获取接口信息接口 GET /api/interfaceInfo/get */
...
/** 获取列表信息接口 GET /api/interfaceInfo/list */
...
/** 分野获取列表接口信息接口 GET /api/interfaceInfo/list/page */
...
/** 更新接口信息接口 POST /api/interfaceInfo/update */
